...
## 🧬 The Molecule System Architecture
...
**4. Flexibility**
- Change label "Carrier Code" → "Airline" updates everywhere
...
## 🎨 Template-Driven Display System
...
display_template_line:
  ...
  template_string: '[M,origin,"Code"],[T," • "],[M,destination,"Code"]'
```
...
**Airlines:** ✅ Configure carrier, origin, destination molecules  
**Hotels:** ✅ Configure hotel_brand, room_type molecules  
**Credit Cards:** ✅ Configure merchant, category molecules  
**Retail:** ✅ Configure store, product_category molecules  
**Gas Stations:** ✅ Configure fuel_grade, location molecules  
