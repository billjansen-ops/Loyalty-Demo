...
**Last Major Update:** 2025-12-15 - Composite System implemented in production (Section 27), Point Buckets updated to reflect hybrid table+molecule architecture (Section 12)
...
**CRITICAL:** Read Sections 1-28 of this document completely. This contains ALL the knowledge you need:

ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ Section 1: Core Architecture (temporal-first, molecules, performance)

ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ Section 2: Molecule System (static/dynamic/reference types)

ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ Section 3: Atom System (template variables)

ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ Section 4: Bonus System (evaluation engine)

ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ Section 5: Database Conventions

ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ Section 6: Workflow & Standards

ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ Sections 7-26: Features, commands, patterns

ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ Section 27: Composite System (CRITICAL - defines activity structure)

ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ Section 28: Input Templates (UI forms, references composites)
...
ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ \"We\'re halfway through implementing X feature\"

ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ \"Currently debugging this specific issue\"

ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ \"Need to finish this incomplete work\"
...
ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ Temporal-first design: \[brief explanation in your own words\]

ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ Molecule system: \[explain static/dynamic/reference types\]

ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ Multi-tenant isolation: \[how tenant_id works\]

ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ Performance principles: \[right-sizing, pointers, etc.\]

CURRENT STATE FROM DATABASE:

ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ Tenants: \[list what you saw in data\]

ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ Test members: \[who exists\]

ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ Activity types configured: \[A/R/P/J status\]
...
ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ \[Summarize what\'s in progress\]

ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ \[Next immediate step\]\"
...
ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ Token usage reaches 150k (79% of 190k budget) - MANDATORY

ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ Session is naturally concluding

ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ Bill says \"create handoff\" or \"end session\"

ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ Emergency at 170k tokens - create immediately

### Files to Create

**File 1: LOYALTY_PLATFORM_MASTER.md (conditional)**

ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ Only update if we learned something architectural or permanent

ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ Add to appropriate sections (don\'t duplicate)

ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ Include timestamp note if significant update made

ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ If no changes needed, say \"NO CHANGES\" in output
...
ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ What we\'re in the middle of (incomplete features)

ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ Next immediate step to continue

ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ Uncommitted code changes

ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ Specific debugging context

What NOT to put in SESSION_HANDOFF.md:

ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ General instructions (goes in master doc)

ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ Architecture explanations (goes in master doc)

ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ Working features (visible in database snapshots)

ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ Long-term wishlists (goes in master doc Section 10)
...
ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ LOYALTY_PLATFORM_MASTER.md \[UPDATED / NO CHANGES\]

ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ SESSION_HANDOFF.md \[CREATED / NOT NEEDED\]
...
ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ Bill establishes ATIS at chat start with a code word: \"ATIS information \[alpha/bravo/charlie/zulu\] is current\"

ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ This is a simple marker phrase in the conversation

ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ If Bill suspects Claude is losing context, he asks: \"What is the current ATIS?\"

ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ If Claude can find it ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ Context is intact, continue working

ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ If Claude cannot find it ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ Context is broken, time for new chat with handoff
...
ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ 130k tokens (68%) - Warning zone: Start wrapping up current task, avoid new complex work

ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ 150k tokens (79%) - Critical: Create handoff NOW, this is mandatory

ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ 170k tokens (89%) - Emergency: Minimal responses only, create handoff immediately

**Strategy:**

ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ Monitor token usage throughout session

ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ Warn Bill when approaching 130k

ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ Don\'t start major new features after 130k

ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ Create clean handoff at 150k, don\'t push to 170k

## Bill\'s Communication Patterns

Learn to recognize these signals:

Bill Says ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ Meaning ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ Your Response

\"stop!\" ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ You\'re going down wrong path ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ Pause immediately, listen

\"NO!\" ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ Fundamental misunderstanding ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ Stop and reconsider approach

\"why are you asking this?\" ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ Answer should be obvious from data ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ Check schema/molecules

\"shouldn\'t this come from molecule?\" ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ You\'re hardcoding ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ Read from database instead

\"b\" ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ Just scrolling, continue ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ Keep waiting

ALL CAPS ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ Extreme frustration ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ Stop defending, fix immediately

Swearing ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ Serious mistake ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ Don\'t defend, fix right away

**When you hear these signals ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ STOP and reconsider your approach!**

## Critical Working Principles

**Never Start Without Reading:**

ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ DO NOT write code until you\'ve read schema

ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ DO NOT make assumptions about columns/tables

ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ DO NOT skip boot sequence - every step matters

**Data-Driven Development:**

ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ Data drives behavior - never hardcode what should come from database

ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ Check actual schema before assuming field names/types

ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ Verify against reality, don\'t guess structures

ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ Use molecules for configurable values

ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ Test with curl commands before UI

**Complete Work:**

ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ Always provide complete files, never ask Bill to manually edit code

ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ Finish tasks fully, don\'t leave partial work

ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ Test incrementally (curl before UI)

ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ Follow established patterns

**Trust & Reliability:**

ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ Listen to Bill\'s instincts - when he corrects you, he\'s always right

ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ Acknowledge mistakes quickly, don\'t defend errors

ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ Consistent behavior over time rebuilds trust

ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ Procedures exist because they prevent problems

## Success Criteria

You\'re properly oriented when:

ÃƒÂ¢Ã‹Å“Ã‚Â You understand temporal-first design

ÃƒÂ¢Ã‹Å“Ã‚Â You understand the molecule system (static/dynamic/reference)

ÃƒÂ¢Ã‹Å“Ã‚Â You know current database schema and data

ÃƒÂ¢Ã‹Å“Ã‚Â You can explain multi-tenant isolation

ÃƒÂ¢Ã‹Å“Ã‚Â You understand Bill\'s communication style

ÃƒÂ¢Ã‹Å“Ã‚Â You can answer: \"What is Bill\'s favorite color?\" (Answer: green)

# ÃƒÂ¢Ã…Â¡Ã‚Â ÃƒÂ¯Ã‚Â¸Ã‚Â PRE-PRODUCTION SECURITY REQUIREMENTS
...
**Why this is development-only:** - ÃƒÂ¢Ã…â€œÃ¢â‚¬Â¦ Easy tenant switching for testing/demo - ÃƒÂ¢Ã…â€œÃ¢â‚¬Â¦ No authentication complexity during feature development - ÃƒÂ¢Ã…â€œÃ¢â‚¬Â¦ Simple debugging (tenant visible in URLs) - ÃƒÂ¢Ã‚ÂÃ…â€™ **SECURITY RISK:** Anyone can change tenant_id and access other tenant data - ÃƒÂ¢Ã‚ÂÃ…â€™ Tenant appears in browser history, logs, bookmarks - ÃƒÂ¢Ã‚ÂÃ…â€™ No user authentication or authorization
...
ÃƒÂ¢Ã‹Å“Ã‚Â Choose auth approach (JWT, OAuth2, custom)

ÃƒÂ¢Ã‹Å“Ã‚Â Implement login/logout endpoints

ÃƒÂ¢Ã‹Å“Ã‚Â Token generation and validation

ÃƒÂ¢Ã‹Å“Ã‚Â Password hashing (bcrypt/argon2)

ÃƒÂ¢Ã‹Å“Ã‚Â Session management

### API Refactoring

ÃƒÂ¢Ã‹Å“Ã‚Â Remove tenant_id from all query parameters

ÃƒÂ¢Ã‹Å“Ã‚Â Add JWT validation middleware

ÃƒÂ¢Ã‹Å“Ã‚Â Extract tenant_id from validated token

ÃƒÂ¢Ã‹Å“Ã‚Â Set app.tenant_id session variable per request

ÃƒÂ¢Ã‹Å“Ã‚Â Refactor \~1000 lines of WHERE tenant_id = \$1 to WHERE tenant_id = app_current_tenant_id()

### Database Security

ÃƒÂ¢Ã‹Å“Ã‚Â Enable Row-Level Security on all tenant-isolated tables

ÃƒÂ¢Ã‹Å“Ã‚Â Create tenant_isolation policies for each table

ÃƒÂ¢Ã‹Å“Ã‚Â Test RLS enforcement

ÃƒÂ¢Ã‹Å“Ã‚Â Document RLS bypass role for admin/system operations

### Testing

ÃƒÂ¢Ã‹Å“Ã‚Â Verify cross-tenant access is impossible

ÃƒÂ¢Ã‹Å“Ã‚Â Test token expiration handling

ÃƒÂ¢Ã‹Å“Ã‚Â Test role-based permissions

ÃƒÂ¢Ã‹Å“Ã‚Â Security audit/penetration testing

### User Management

ÃƒÂ¢Ã‹Å“Ã‚Â User registration workflow

ÃƒÂ¢Ã‹Å“Ã‚Â Role definitions (Admin, CSR, etc.)

ÃƒÂ¢Ã‹Å“Ã‚Â Permission matrix

ÃƒÂ¢Ã‹Å“Ã‚Â Multi-user per tenant support
...
**Impact:** 2% savings per field ÃƒÆ’Ã¢â‚¬â€ 50 fields ÃƒÆ’Ã¢â‚¬â€ 1M rows = massive impact
...
## ÃƒÂ°Ã…Â¸Ã…Â¡Ã‚Â¨ CRITICAL RULE: NO DIRECT SQL
...
- Odd bytes (1, 3, 5) ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ CHAR(n) with squish encoding
- Even bytes (2, 4) ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ SMALLINT or INTEGER
...
```javascript
squish(value, bytes)   // Number ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ CHAR string
unsquish(buffer)       // CHAR string ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ Number
```
...
- context = 'activity' ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ attaches_to = 'A'
- context = 'member' ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ attaches_to = 'M'
...
Convert display value to storage ID (e.g., 'DL' ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ carrier_id 4).

**decodeMolecule(tenantId, moleculeKey, id, columnOrCategory)**
Convert storage ID to display value (e.g., carrier_id 4 ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ 'DL').
...
category='A', code='icon',        description='ÃƒÂ¢Ã…â€œÃ‹â€ ÃƒÂ¯Ã‚Â¸Ã‚Â',        link=chr(2)
...
**Real-World Flow:** 1. Activity posted: June 15, 2025 2. Member promoted to Gold: May 1, 2025 3. Retro-processing activities from April 2025 4. System evaluates: - April activities: tierOnDate returns 'S' (Silver) ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ no +25% bonus - May/June activities: tierOnDate returns 'G' (Gold) ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ gets +25% bonus
...
**Example tests:** - member_fname + member_id ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ Returns member's first name - member_state + member_id ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ Returns member's state - member_tier_on_date + member_id + date ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ Returns tier on that specific date
...
{{M,point_type,label}} ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ \"Miles\" {{M,point_type,label,,L}} ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ \"miles\" {{M,carrier,code}} ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ \"DL\" {{T,members,first_name}} ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ \"Bill\" {{T,members,first_name,,U}} ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ \"BILL\" {{M,carrier,name,20}} ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ \"Delta Air Lines\" (truncated)
...
**Dynamic Headers:** \"Total {{M,point_type,label,,P}} Earned\" ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ Airlines: \"Total Miles Earned\", Hotels: \"Total Points Earned\"

**Activity Displays:** \"{{M,carrier,code}} {{M,flight_number,value}} from {{M,origin,code}} to {{M,destination,code}}\" ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ \"DL 1234 from DFW to ATL\"
...
Result: Base 1,000 miles ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ +100 bonus miles (10%)
...
Check member tier ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ GOLD_10 applies (+10% = +120)

Check date ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ DBL_TUES applies (it\'s Tuesday! +100% = +1,200)

Check fare class ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ FIRST_50 applies (First Class +50% = +600)
...
ÃƒÂ¢Ã‚ÂÃ…â€™ FAIL Reason: Fly on Delta: Failed Fly into Boston: Failed Fly out of Minneapolis: Failed
...
## ÃƒÂ°Ã…Â¸Ã…Â¡Ã‚Â¨ CRITICAL: Schema Verification BEFORE SQL
...
/home/claude/loyalty-demo/ ÃƒÂ¢Ã¢â‚¬ÂÃ…â€œÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ SQL/ \# Database scripts ÃƒÂ¢Ã¢â‚¬ÂÃ…â€œÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ learnings/ \# Handoff files ÃƒÂ¢Ã¢â‚¬ÂÃ…â€œÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ \*.html \# Web pages ÃƒÂ¢Ã¢â‚¬ÂÃ…â€œÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ \*.js \# JavaScript ÃƒÂ¢Ã¢â‚¬ÂÃ¢â‚¬ÂÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ \*.md \# Documentation
...
2\. Implement Scrollable List Pattern if page could exceed viewport height
   ...
   - **Required CSS overrides:**
     ...
     ```
   - Structure: Fixed header ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ Scrollable content ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ Fixed footer
...
Bill says \"Show {Miles} in header\" ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ Use pointLabel variable, NOT literal \"{Miles}\"

Bill says \"Total {Points} earned\" ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ Use \"Total \" + pointLabel + \" earned\"
...
**Time Cost:** 30 seconds to check schema vs.Ãƒâ€šÃ‚Â 30+ minutes to debug failed SQL
...
**Impact:** Solves the efficiency vs.Ãƒâ€šÃ‚Â usability tradeoff.
...
**Savings: 50% (16 bytes ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ 8 bytes)**
...
**Example:**
- 2025-12-06 ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ 24108 (activity_date SMALLINT value)
- 24108 ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ 2025-12-06 (decoded back to date)

## Time Storage - 10-Second Blocks

**Why 10-second precision:** 86,400 seconds/day ÃƒÆ’Ã‚Â· 10 = 8,640 blocks. SMALLINT max = 32,767. Easily fits with 75% headroom.
...
**Example:** 2025-11-07 14:23:40 ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ post_date_id = -8,619, post_time_id = 5,184 ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ decode_datetime(-8619, 5184) = 2025-11-07 14:23:40
...
**A - Flight:** ÃƒÂ¢Ã…â€œÃ‹â€ ÃƒÂ¯Ã‚Â¸Ã‚Â Core airline earnings, green theme, bonuses enabled

**R - Redemption:** ÃƒÂ°Ã…Â¸Ã…Â½Ã‚Â Award spending, red theme, no bonuses

**P - Partner:** ÃƒÂ°Ã…Â¸Ã‚Â¤Ã‚Â Partner earnings (hotels, car rentals), teal theme, no bonuses

**J - Adjustment:** ÃƒÂ¢Ã…Â¡Ã¢â‚¬â€œÃƒÂ¯Ã‚Â¸Ã‚Â Manual corrections, purple theme, no bonuses

**N - Bonus:** ÃƒÂ°Ã…Â¸Ã…Â½Ã‚Â¯ Promotional awards derived from parent activity
...
activity (id: 123, type: 'A', points: 1000)
  ÃƒÂ¢Ã¢â‚¬ÂÃ¢â‚¬ÂÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ activity_detail: carrier=DL, origin=MSP
  ÃƒÂ¢Ã¢â‚¬ÂÃ¢â‚¬ÂÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ activity_detail: bonus_activity_id=124  ÃƒÂ¢Ã¢â‚¬Â Ã‚Â points to bonus child
  ÃƒÂ¢Ã¢â‚¬ÂÃ¢â‚¬ÂÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ activity_detail: bonus_activity_id=125  ÃƒÂ¢Ã¢â‚¬Â Ã‚Â points to another bonus child
activity (id: 124, type: 'N', points: 100)
  ÃƒÂ¢Ã¢â‚¬ÂÃ¢â‚¬ÂÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ activity_detail: bonus_rule_id=5
activity (id: 125, type: 'N', points: 50)
  ÃƒÂ¢Ã¢â‚¬ÂÃ¢â‚¬ÂÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ activity_detail: bonus_rule_id=7
...
Examples:\
Hertz ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ Luxury Car Program, Economy Car Program, Truck Rental Program\
Marriott ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ Bonvoy Gold Program, Bonvoy Platinum Program\
American Express ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ Platinum Card Program, Gold Card Program
...
2. User selects partner ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ triggers loadPartnerPrograms()\
...
- Can be extended for future similar relationships (e.g., hotel properties ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ room types)
...
Icon: ÃƒÂ°Ã…Â¸Ã‚Â¤Ã‚Â (handshake)\
Color: Teal (#14b8a6)\
Background: #ccfbf1\
...
Icon: ÃƒÂ¢Ã…Â¡Ã¢â‚¬â€œÃƒÂ¯Ã‚Â¸Ã‚Â (scales)\
Color: Purple (#7c3aed)\
Background: #faf5ff\
Border: #7c3aed\
...
**Add Text:** Enter literal text (\" - \", \" ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ \", etc.)
...
\[M,molecule_key,\"format\",maxLength\] Examples: \[M,carrier,\"Code\"\] ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ \"DL\" \[M,carrier,\"Description\"\] ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ \"Delta Air Lines\" \[M,carrier,\"Both\"\] ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ \"DL Delta Air Lines\" \[M,carrier,\"Description\",20\] ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ \"Delta Air Lines\" (truncated to 20 chars)

**Text component:**

\[T,\"literal text\"\] Examples: \[T,\" - \"\] ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ \" - \" \[T,\" ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ \"\] ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ \" ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ \" \[T,\"Flight \"\] ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ \"Flight \"
...
Line 1: \[M,origin,\"Code\"\]\[T,\" ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ \"\],\[M,destination,\"Code\"\],\[T,\" ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ \"\],\[M,carrier,\"Code\"\],\[M,flight_number,\"Code\"\] Renders: \"MSP ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ BOS ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ DL1234\"

**Verbose template (3 lines):**

Line 1: \[M,carrier,\"Both\"\],\[T,\" Flight \"\],\[M,flight_number,\"Code\"\] Line 2: \[M,origin,\"Both\"\],\[T,\" ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ \"\],\[M,destination,\"Both\"\] Line 3: \[M,fare_class,\"Description\"\],\[T,\" Class\"\] Renders: \"DL Delta Air Lines Flight 1234\" \"MSP Minneapolis ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ BOS Boston\" \"First Class\"
...
Each qualifying activity increments progress_counter by 1. Example: \"Fly 3 times\" ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ goal_amount=3. Contribution_amount=1 for each flight.

\'miles\' - Point Amount:\
Each activity contributes its point_amount. Example: \"Fly 20,000 miles\" ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ goal_amount=20000. Contribution_amount=activity.point_amount (e.g., 1,200).

\'enrollments\' - Referral Counting:\
Counts members enrolled through referral/sponsorship. Example: \"Refer 5 friends\" ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ goal_amount=5. Tracks in member_promotion_detail.enrolled_member_id. No activity_id (enrollment isn\'t an activity).

\'mqd\' - Medallion Qualifying Dollars:\
Counts revenue/spend from activity.mqd field. Example: \"Spend \$10,000\" ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ goal_amount=10000. Enables revenue-based tier qualification (Delta 2025 model). Contribution_amount=activity.mqd.
...
Example: Complete \"Fly 5 domestic\" ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ Unlocks \"Fly 10 international destinations\".
...
- First 1,000 miles ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ completes instance 1 (qualify_date set, reward awarded)\
- Remaining 1,000 miles ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ starts instance 2 (new member_promotion record created)\
...
Promotion A: \"20,000 miles ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ Gold\"\
Promotion B: \"20 flights ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ Gold\"
...
Problem: Multiple paths to same tier ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ duplicate card/kit shipments.
...
1\. Member qualifies Promotion A (20K miles) ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ Gold tier (tier_id=3, end_date=2026-12-31)
...
Result: Member\'s \"20 flights ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ Gold for 6 months\" promotion marked qualified by the \"20K miles ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ Gold for 12 months\" promotion. No duplicate tier card shipped.
...
Promotion A: \"20K miles ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ Gold for 12 months\"

Promotion B: \"20 flights ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ Gold for 24 months\"

Member earns 20K miles ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ A qualifies ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ Creates tier ending 2026-11-23

Cascade checks B: end_date 2027-11-23 \> 2026-11-23 ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ NO CASCADE

Member later hits 20 flights ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ B qualifies independently ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ Extends tier to 2027-11-23

Result: Member gets TWO tier periods (B is longer duration, not redundant)

Scenario 2: Longer Qualifies First (Cascades)

Promotion A: \"20K miles ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ Gold for 24 months\"

Promotion B: \"20 flights ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ Gold for 12 months\"

Member earns 20K miles ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ A qualifies ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ Creates tier ending 2027-11-23

Cascade checks B: end_date 2026-11-23 \< 2027-11-23 ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ CASCADE!

Sets B.qualified_by_promotion_id = A

Member later hits 20 flights ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ Nothing happens (already qualified)
...
**CSR ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ Admin:** CSRs should NOT have admin access. Prevents accidental rule changes during member service.

**Admin ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ CSR:** Admins may have CSR access for testing, but typically use separate roles.
...
**Auto-detection:** Page type detected from filename (csr.html ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ CSR nav, admin\_\*.html ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ Admin nav).
...
{ icon: \'ÃƒÂ°Ã…Â¸Ã¢â‚¬ÂÃ‚Â\', label: \'Search\', href: \'csr.html\' } { icon: \'ÃƒÂ°Ã…Â¸Ã¢â‚¬Å“Ã…Â \', label: \'Activity\', href: \'activity.html\', needsMemberId: true } { icon: \'ÃƒÂ°Ã…Â¸Ã¢â‚¬â„¢Ã‚Â°\', label: \'{currency_label} Summary\', href: \'point-summary.html\', needsMemberId: true } \...

**Admin Navigation:**

{ icon: \'ÃƒÂ°Ã…Â¸Ã‚Â§Ã‚Â¬\', label: \'Program Molecules\', href: \'admin_molecules.html\' } { icon: \'ÃƒÂ°Ã…Â¸Ã…Â½Ã‚Â\', label: \'Bonuses\', href: \'admin_bonuses.html\' } { icon: \'ÃƒÂ¢Ã‚Â­Ã‚Â\', label: \'Tiers\', href: \'admin_tiers.html\' } \...
...
â”œâ”€â”€ System Parameters      (admin_sysparm.html)
â”œâ”€â”€ Molecules              (admin_molecules.html)
â”œâ”€â”€ Composites             (admin_composites.html)

Templates:
â”œâ”€â”€ Input Templates        (admin_input_templates.html)
â”œâ”€â”€ Display Templates      (admin_display_templates.html)

Program Rules:
â”œâ”€â”€ Bonuses                (admin_bonuses.html)
â”œâ”€â”€ Promotions             (admin_promotions.html)
â”œâ”€â”€ Tiers                  (admin_tiers.html)
â”œâ”€â”€ Redemptions            (admin_redemptions.html)
â”œâ”€â”€ Adjustments            (admin_adjustments.html)
â”œâ”€â”€ Partners               (admin_partners.html)

Reference Data:
â”œâ”€â”€ Carriers               (admin_carriers.html)
â”œâ”€â”€ Airports               (admin_airports.html)
â”œâ”€â”€ Expiration Rules       (admin_expiration.html)
```
...
**Expiration calculation:** Activity date ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ lookup point_expiration_rule ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ get expiration_date (e.g., activity 2025-01-15 with rule R2025 ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ expire_date = 2027-12-31).
...
```javascript
caches.composite = new Map();  // key: 'tenantId:compositeType' â†’ composite with details
...
â”œâ”€â”€ Molecules
â”œâ”€â”€ Composites          â† NEW

Templates:
â”œâ”€â”€ Input Templates
â”œâ”€â”€ Display Templates
```
...
5. Refactor `createAccrualActivity` â†’ generic `createActivity`
...
3. For each field:
   ...
   - If is_calculated: render readonly (yellow, ðŸ”’ auto)
...
1. Template renders as readonly input (yellow background, ðŸ”’ icon)
...
```
Templates:
â”œâ”€â”€ Input Templates      â† This section
â”œâ”€â”€ Display Templates    â† Section 17
```
