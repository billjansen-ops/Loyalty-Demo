 ...
 * Single drop‑in file. No manual edits elsewhere.
 */
...
// CORS (allow common local origins)
const allow = new Set([
  'http://127.0.0.1:4000',
  'http://localhost:4000',
...
// ------- Minimal data set to satisfy Activity page -------
const member = { member_id: '2153442807', name: 'Bill Jansen', tenant_id: '1' };

const activities = [
  { activity_date: '2025-10-23', type: 'Flight', miles: 1508,
    details: { carrier: 'DL', from: 'MSP', to: 'LGA', flight: '104', class: 'F' } },
  { activity_date: '2025-09-01', type: 'Partner', miles: 1250,
    details: { partner: 'Marriott', ref: '7HF3D', nights: 3, city: 'NYC' } },
  { activity_date: '2025-08-17', type: 'Adjustment', miles: 500,
    details: { csr: 'JSantana', case: '#88421', reason: 'Policy Exception' } },
  { activity_date: '2025-07-31', type: 'Promotion', miles: 750,
    details: { name: 'Summer Sprint', cycle: 1, progress: '2/3' } },
];
...
// Search (e.g., /v1/member/search?q=2153442807)
...
// Activities (e.g., /v1/member/2153442807/activities?limit=50)
...
// Balances (e.g., /v1/member/2153442807/balances)
