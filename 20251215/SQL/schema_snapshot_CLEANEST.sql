...
\restrict 7CN12VTYkPhpesI8UuVQfvxWpl3SK94THYtFGHOBktK0p2iR6ixLtNyLYrTyQfC
...
CREATE TABLE public.activity (
    ...
    lot_id bigint,
    mqd numeric DEFAULT 0
);


--
-- Name: COLUMN activity.mqd; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.activity.mqd IS 'Revenue/spend amount for revenue-based promotions (e.g., Medallion Qualifying Dollars)';
...
CREATE TABLE public.member_promotion_detail (
    ...
    CONSTRAINT valid_promotion_detail_link CHECK ((((activity_id IS NOT NULL) AND (enrolled_member_id IS NULL)) OR ((activity_id IS NULL) AND (enrolled_member_id IS NOT NULL))))
);
...
--
-- Name: COLUMN member_promotion_detail.activity_id; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.member_promotion_detail.activity_id IS 'Activity that contributed (NULL for enrollment counting)';
...
CREATE TABLE public.promotion (
    ...
    CONSTRAINT promotion_count_type_check CHECK (((count_type)::text = ANY ((ARRAY['flights'::character varying, 'miles'::character varying, 'enrollments'::character varying, 'mqd'::character varying])::text[]))),
    CONSTRAINT promotion_duration_days_check CHECK (((duration_days IS NULL) OR (duration_days > 0))),
    CONSTRAINT promotion_duration_type_check CHECK (((duration_type IS NULL) OR ((duration_type)::text = ANY ((ARRAY['calendar'::character varying, 'virtual'::character varying])::text[])))),
    ...
    CONSTRAINT promotion_reward_type_check CHECK (((reward_type)::text = ANY ((ARRAY['points'::character varying, 'tier'::character varying, 'external'::character varying, 'enroll_promotion'::character varying])::text[]))),
...
--
-- Name: idx_promotion_detail_activity; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_promotion_detail_activity ON public.member_promotion_detail USING btree (activity_id);
...
--
-- Name: member_promotion_detail member_promotion_detail_activity_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.member_promotion_detail
    ADD CONSTRAINT member_promotion_detail_activity_id_fkey FOREIGN KEY (activity_id) REFERENCES public.activity(activity_id);
...
\unrestrict 7CN12VTYkPhpesI8UuVQfvxWpl3SK94THYtFGHOBktK0p2iR6ixLtNyLYrTyQfC
