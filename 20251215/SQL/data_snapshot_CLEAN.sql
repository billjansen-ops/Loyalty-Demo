...
\restrict L66K8byWEJsp7Cd4paTk2Ww7CEC0Vli6jwdXyU7eBPoo8SR0mHIo8sUY54zrTo2
...
13	2153442807	miles	2027-12-31	9300	0	\N
14	1003	miles	2027-12-31	1000	0	\N
\.
...
38	2153442807	2025-11-11	2025-11-11	A	1000	13	0
39	2153442807	2025-11-10	2025-11-11	A	1000	13	0
40	2153442807	2025-11-18	2025-11-17	P	1000	13	0
41	2153442807	2025-11-18	2025-11-18	P	500	13	0
42	2153442807	2025-11-18	2025-11-18	P	1000	13	0
43	2153442807	2025-11-18	2025-11-18	P	300	13	0
44	2153442807	2025-11-18	2025-11-18	J	2500	13	0
45	2153442807	2025-11-18	2025-11-18	A	1200	13	0
46	1003	2025-11-22	2025-11-22	A	1000	14	0
\.
...
19	38	8	100	2025-11-11 16:11:03.273125-06	\N
20	39	8	100	2025-11-11 16:24:03.570615-06	\N
21	45	6	200	2025-11-18 04:01:12.422263-06	\N
\.
...
COPY public.member_promotion (member_promotion_id, member_id, promotion_id, tenant_id, enrolled_date, qualify_date, process_date, progress_counter, enrolled_by_user_id, qualified_by_user_id, goal_amount) FROM stdin;
\.
...
SELECT pg_catalog.setval('public.activity_activity_id_seq', 46, true);
...
SELECT pg_catalog.setval('public.activity_bonus_activity_bonus_id_seq', 21, true);
...
SELECT pg_catalog.setval('public.member_promotion_detail_detail_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.member_promotion_member_promotion_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.molecule_def_molecule_id_seq', 30, true);
...
SELECT pg_catalog.setval('public.molecule_value_lookup_lookup_id_seq', 9, true);
...
SELECT pg_catalog.setval('public.point_lot_lot_id_seq', 14, true);
...
SELECT pg_catalog.setval('public.redemption_detail_redemption_detail_id_seq', 6, true);
...
\unrestrict L66K8byWEJsp7Cd4paTk2Ww7CEC0Vli6jwdXyU7eBPoo8SR0mHIo8sUY54zrTo2
