...
module.exports = {
  ...
  async run(ctx) {
    ...
    const paulRes = sql(`SELECT resolution_code FROM intake_item WHERE member_link = '${paulLink}' AND tenant_id = ${TENANT} ORDER BY link DESC LIMIT 1 -- lint-allow: intake_item.link is INTEGER`);
