...
const MemberSearchAPI = {
  ...
  /**
   * Search for members by alias value
   * @param {string} aliasValue - The alias value to search for
  ...
  /**
   * Map alias search result to standard member object (with alias info)
   * @param {Object} obj - Alias search result
   * @returns {Object|null} Standardized member object with alias info
   */
  mapAliasResult: function(obj) {
    if (!obj) return null;
    ...
    return {
      ...
      link: obj.member_link || '',
      fname: obj.fname || '',
      lname: obj.lname || '',
      email: obj.email || '',
      // Alias-specific info
      alias_value: obj.alias_value || '',
      alias_type: obj.composite_name || '',
      alias_source: obj.decoded_key || obj.molecule_label || ''
    };
  },
