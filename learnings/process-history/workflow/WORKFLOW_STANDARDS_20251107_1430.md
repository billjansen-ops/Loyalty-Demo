...
**Location:** Admin → Display Templates
...
**Solution:**
- Reduce padding: 12px → 6-8px
- Reduce margins: 12px → 8px  
- Reduce font sizes: 22px → 18px (title), 15px → 13px (sections)
- Reduce input padding: 8px → 6px
...
**Action:** When user says "review this chat" or "find in chat" → search carefully and read found sections
...
**Action:** When user expresses frustration → stop, acknowledge mistakes, ask for clarification

### Red Flags From This Session

- **"read this chat"** → Claude didn't search carefully enough
- **"you are so frustrating"** → Making repeated mistakes, need to slow down  
- **"so when I told you..."** → Claude misunderstood instructions
- **"I believe you"** (sarcastically) → Claude is overconfident without testing
- **"good answer!"** (after trick question) → Claude finally got it right

### Green Flags From This Session

- **"better"** → Progressing in right direction
- **"confirmed"** → Understanding is correct
- **"that looks good"** → Design decision approved
- **"yes"** → Simple affirmative on direct question
