...
const SERVER_VERSION = "2026.02.21.2100";
const SESSION_CLEANUP_COUNT = 3;  // Expired sessions deleted per login - tune as needed
const BUILD_NOTES = "Opportunistic session cleanup at login via sysparm session_cleanup_count, disabled connect-pg-simple background pruning";
